...
// 通用节点组件
const CineGraphNodeComponent: React.FC<{ data: NodeData; selected: boolean }> = ({ data, selected }) => {
...
const nodeTypes: NodeTypes = {
  'default': CineGraphNodeComponent,
  'creative-description': CineGraphNodeComponent,
  'text-to-image': CineGraphNodeComponent,
  'text-to-video': CineGraphNodeComponent,
  'inspiration-music': CineGraphNodeComponent,
  'video-analysis': CineGraphNodeComponent,
  'image-edit': CineGraphNodeComponent,
  'text-node': CineGraphNodeComponent,
  'image-node': CineGraphNodeComponent,
  'video-node': CineGraphNodeComponent,
};

// ==================== 画布内部组件 ====================

interface CineGraphCanvasInnerProps {
  nodes: StudioNode[];
  edges: Edge[];
...
const CineGraphCanvasInner: React.FC<CineGraphCanvasInnerProps> = ({
  nodes,
  onNodesChange,
  onNodeClick,
  onDoubleClick,
...
interface CineGraphCanvasProps {
  nodes: StudioNode[];
  edges: Edge[];
  onNodesChange: (changes: any) => void;
  onNodeClick: (node: any) => void;
...
const CineGraphCanvas: React.FC<CineGraphCanvasProps> = (props) => {
  return (
    <ReactFlowProvider>
      <CineGraphCanvasInner {...props} />
    </ReactFlowProvider>
  );
};

export default CineGraphCanvas;
