...
class DatabaseManager:
    ...
    def _init_default_model_providers(self, session):
        """初始化默认的模型提供者配置（精简版：11 LLM + 5 Embedding）"""
        default_providers = [
            # ==================== LLM 提供者 (11个) ====================
            # --- 本地 Ollama ---
            ModelProvider(
                ...
                description='通过Ollama运行的本地Qwen3 4B模型，轻量快速',
            ...
            ModelProvider(
                ...
                description='Ollama云端DeepSeek V3.1',
                price_info='免费(有配额)', is_default=True, sort_order=20,
            ),
            ModelProvider(
                id='ollama_cloud_qwen_vl', name='Qwen3-VL:235B (Ollama云)',
                category='llm', provider_type='local', local_mode='ollama',
                base_url='http://localhost:11434/v1', model='qwen3-vl:235b-cloud',
                max_tokens=4000, temperature=0.7, timeout=150,
                description='Ollama云端Qwen3 VL多模态',
            ...
            ModelProvider(
                ...
                description='DeepSeek V3，中文效果极佳，性价比最高',
            ...
            ModelProvider(
                ...
                model='qwen-max-latest', api_key='${DASHSCOPE_API_KEY}',
                max_tokens=4000, temperature=0.7, timeout=45,
                description='阿里云通义千问Max，最强中文能力',
                price_info='¥2/百万token(输入) ¥6/百万token(输出)',
                is_default=True, sort_order=40,
            ),
            ModelProvider(
                id='openai_gpt4o', name='GPT-4o',
                category='llm', provider_type='commercial', local_mode='',
                base_url='https://api.openai.com/v1', model='gpt-4o',
                api_key='${OPENAI_API_KEY}',
                max_tokens=4000, temperature=0.7, timeout=30,
                description='OpenAI GPT-4o，强大的多模态能力',
                price_info='$2.5/百万token(输入) $10/百万token(输出)',
                is_default=True, sort_order=50,
            ),
            ModelProvider(
                id='moonshot_kimi_k1', name='Kimi-K1',
                category='llm', provider_type='commercial', local_mode='',
                base_url='https://api.moonshot.cn/v1', model='kimi-k1',
                api_key='${MOONSHOT_API_KEY}',
                max_tokens=4000, temperature=0.7, timeout=45,
                description='Moonshot Kimi K1，超长上下文支持',
                price_info='¥6/百万token(输入)',
                is_default=True, sort_order=60,
            ),
            ModelProvider(
                id='zhipu_glm4', name='GLM-4',
                category='llm', provider_type='commercial', local_mode='',
                base_url='https://open.bigmodel.cn/api/paas/v4',
                model='glm-4', api_key='${ZHIPU_API_KEY}',
                max_tokens=4000, temperature=0.7, timeout=45,
                description='智谱GLM-4，中文能力强大',
                price_info='¥5/百万token(输入)',
                is_default=True, sort_order=70,
            ),
            ModelProvider(
                id='anthropic_claude_sonnet', name='Claude 3.5 Sonnet',
                category='llm', provider_type='commercial', local_mode='',
                base_url='https://api.anthropic.com/v1', model='claude-3-5-sonnet-20241022',
                api_key='${ANTHROPIC_API_KEY}',
                max_tokens=4000, temperature=0.7, timeout=45,
                description='Anthropic Claude 3.5 Sonnet，最佳综合能力',
                price_info='$3/百万token(输入) $15/百万token(输出)',
                is_default=True, sort_order=80,
            ),
            ModelProvider(
                id='google_gemini_pro', name='Gemini 2.0 Flash',
                category='llm', provider_type='commercial', local_mode='',
                base_url='https://generativelanguage.googleapis.com/v1beta',
                model='gemini-2.0-flash', api_key='${GOOGLE_API_KEY}',
                max_tokens=4000, temperature=0.7, timeout=45,
                description='Google Gemini 2.0 Flash，快速高效',
                price_info='免费(有配额)',
                is_default=True, sort_order=90,
            ),
            ...
            ModelProvider(
                ...
                description='本地Qwen3 Embedding模型',
                price_info='免费', is_active=True, is_default=True, sort_order=10,
            ),
            # --- 商用 API ---
            ModelProvider(
                ...
                description='硅基流动BGE-M3，多语言效果极佳',
                price_info='免费',
            ...
            ModelProvider(
                ...
                dimension=1024, timeout=30, api_style='openai',
                description='阿里云Embedding V3，中文最优',
                price_info='¥0.0007/千token',
                is_default=True, sort_order=30,
            ),
            ModelProvider(
                id='openai_embedding_large', name='text-embedding-3-large (OpenAI)',
                category='embedding', provider_type='commercial', local_mode='',
                base_url='https://api.openai.com/v1',
                model='text-embedding-3-large', api_key='${OPENAI_API_KEY}',
                dimension=3072, timeout=45, api_style='openai',
                description='OpenAI Embedding Large，最强性能',
                price_info='$0.13/百万token',
                is_default=True, sort_order=40,
            ),
            ModelProvider(
                id='deepseek_embedding', name='DeepSeek-Embedding',
                category='embedding', provider_type='commercial', local_mode='',
                base_url='https://api.deepseek.com/v1',
                model='deepseek-embedding', api_key='${DEEPSEEK_API_KEY}',
                dimension=1024, timeout=30, api_style='openai',
                description='DeepSeek Embedding，中文高性价比',
                price_info='¥0.5/百万token',
                is_default=True, sort_order=50,
            ),
        ]
